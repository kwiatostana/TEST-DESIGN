...
| Предугадывание ошибок | Нестандартные случаи: пустой токен, спецсимволы, пробелы, большой productId |
...
| TC_ERR_019 | Запрос статуса продукта, массив значений в параметре region | Общие | Отправить GET-запрос на `/products/1/status?authToken=Ab1Cd2Ef3Gh4Ij5K&region[]=Сибирь&region[]=Поволжье` | (примечание: поведение не специфицировано в ТЗ, предположительно HTTP-код **200 OK**, параметр игнорируется) | не требуется |
---
